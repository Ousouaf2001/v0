    ...
    function PublicationsGetAllById() {
        ...
        $.ajax({
          ...
          success:function(result){
                         //alert(result.publications[0].toSource());    
						 ...
						 "<div class='col-xs-3'>"+
						  ...
						  "<div class='col-xs-6'>"+
							"<div class='row'>"+
								...
								"</div>"+
								"<div class='col-xs-12'>"+
									"<button class='btn btn-sm btn_index'>Video</button> &nbsp;"+
									"<button class='btn btn-sm btn_index'> Link</button>&nbsp;"+
									"<button class='btn btn-sm  btn_index'> Photo</button>"+
								"</div>"+
							"</div>"+
						  "</div>"+
						  "<div class='col-xs-3'>"+
